...
//const userAuth = { email: 'arsuhan677@gmail.com', password: 'ADMIN' };

const login = async () => {
    const q = query(collection(db, 'client'), where('email', '==', email.value), where('password', '==', password.value));
    //console.log('hello');
    let flag = false;
    let data = ''
    ...
    if (flag) {
        ...
        alert('there is no users please create a new users from regestration !');
    }
};
</script>
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 xs:text-xl lg:text-3xl font-medium mb-4">Welcome to User PrimeLand!</div>
                    ...
                    <div>
                        ...
                        <label for="password1" class="xs:-mt-4 lg:mt-2 block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Password</label>
